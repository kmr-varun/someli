    ...
    <section className="relative w-full bg-white py-[100px]">
      <div className="max-w-[1440px] mx-auto px-24">
        ...
        <div className="flex flex-col items-center gap-4 mb-16">
          ...
          {/* Heading */}
          <h2 className="font-montserrat font-bold text-[60px] text-[#222222] tracking-[-2px] leading-[71.4px] text-center">
            Why Someli leads the MENA region?
          </h2>

          {/* Subtext */}
          <p className="font-montserrat font-normal text-[18px] text-[#444444] leading-[1.5] text-center">
