...
const steps = [
  {
    ...
    description:
      "We analyze your voice, personality, leadership style, expertise, and goals to build your unique brand blueprint",
    align: "left" as const,
  },
  {
    number: "02/",
    ...
    description:
      "We align with our company's brand guidelines, messaging, and strategic objectives",
  ...
  },
  {
    ...
    description:
      "AI builds your pillars, themes, and content plan tailored to your audience and industry",
    align: "left" as const,
  },
  {
    number: "04/",
    title: "Delivers & Optimised",
    description:
      ...
      <div className="max-w-[1440px] mx-auto px-6 sm:px-10 md:px-16 lg:px-24 py-16 lg:py-[100px]">
        ...
        <div className="flex flex-col items-center text-center mb-12 lg:mb-20">
          ...
          <p className="font-montserrat font-normal text-[18px] text-black leading-[1.36] max-w-[808px]">
            Our AI creates a personalized branding and content engine that works for you 24/7
          </p>
        </div>
